...
if ($count) {
  ...
  while ($data=mysql_fetch_array($results))
  {
   ...
   if ($GLOBALS["usepopup"])
       echo "\t<TD align=\"left\" class=\"lista\"><A HREF=\"javascript:popdetails('details.php?id=".$data["hash"]."');\" title=\"".VIEW_DETAILS.": ".$data["filename"]."\">".$data["filename"]."</A>".($data["external"]=="no"?"":" (<span style=\"color:red\">EXT</span>)")."</td>";
   else
