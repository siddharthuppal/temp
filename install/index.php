...
define ( 'TRACKER_VERSION', 'BtiTracker (1.4.8)' );
define ( 'TIMENOW', time());
...
// CREATE ADMIN ACCOUNT
    ...
    $pwd=mysql_escape_string($_POST["wantpassword"]);
    $pwd1=mysql_escape_string($_POST["passwagain"]);
...
<?php echo TRACKER_VERSION;?>  requires PHP 4.1.2 or better and an MYSQL database.<br><br>

<b>You will also need the following information that your webhost can provide:</b><br>
MYSQL 3.23 or greater. (I recommend: Mysql 5)<br>
PHP version 4.1 or greater. (I recommend: PHP 5)<br>
The Apache webserver (version 1.3 or greater.) Note: This source tested on Apache 2 (I recommend: Apache2).<br>
...
<?php
/*
    tr("Mysql Host? ","<input type='text' size='45' name=mysql_host value='".($CONNECTION["mysql_host"] ? $CONNECTION["mysql_host"] : "localhost")."'> Please enter your mysql host name.\n", 1);
    tr("Mysql User? ","<input type='text' size='45' name=mysql_user value='".($CONNECTION["mysql_user"] ? $CONNECTION["mysql_user"] : "root")."'> Please enter your mysql user name.\n", 1);
    tr("Mysql Password? ","<input type='password' size='45' name=mysql_pass value=''> Please enter your mysql password.\n", 1);
    tr("Mysql Database Name? ","<input type='text' size='45' name=mysql_db value='".($CONNECTION["mysql_db"] ? $CONNECTIO["mysql_db"] : "torrent")."'> Please enter database name of your tracker.\n", 1);
*/
