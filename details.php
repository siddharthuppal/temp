...
// comments...
$subres = mysql_query("SELECT comments.id, text, UNIX_TIMESTAMP(added) as data, user, users.id as uid FROM comments LEFT JOIN users ON comments.user=users.username WHERE info_hash = '" . $id . "' ORDER BY added DESC");
